...
var treeRoutes = require('./tree/treeapi');

//OPF403  regcmdapi ###
//path => ./gotest5_opf403/regcmd/regcmd_gx8.js
var regcmdRoutes = require('./regcmd/regcmd_gx8');

var cmdcode = require("./handelrs485");
var ch1com = require('./utx6x1')// rec oxfa and 0xfc command 
...
var sbcount = 0;
var sensorbuff = [
["C602","CA01","CA02","C101","C104","C107","C102","C103"],	//0
["C602","CA01","CA02","C101","C104","CA03","CA04","CA05"],	//1
["C602","CA01","CA02","C101","C104","C105","C106"]			//2
]
...
//=== alarm key event ===
var alarmbuff = [];
var alarmloadurl = "http://localhost:3001/alarm"
...
var keypadbuff =[];
var key105loadurl =  "http://localhost:3001/keypad"  //localhost:3001/keypad?KEY=94&STATE=00&EVENT=2
    ...
    fs.readFile(filepath, function(err, content) {
		...
		if(pdjobj.PDDATA.linkoffmode == 0){//ext web mode
			ngrok.connect(setport,function (err, url) {
				...
				setddsnurl = ddsnurl+3*10'?DeviceIP='+seturl+'&UUID='+setuuid
